...
public class Chain {
    public final static BlockInfo[] structure = {new BlockInfo(0, 0, 0, Material.CHAIN)};
    public final static String[] willCounter = {"§fCalcite", "NetherBricks"};
    public final static Move move = new Move(new Structure(structure), "§8Chain", new String[]{"Counters §fCalcite.", "Counters §4Nether Bricks.", "Place ON TOP of it, and ", "it will flip back 4♥ damage."}, Util.emptyStringArr, willCounter) {
