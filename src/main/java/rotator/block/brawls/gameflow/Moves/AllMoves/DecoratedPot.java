...
public class DecoratedPot {
    public final static BlockInfo[] structure = {new BlockInfo(0, 0, 0, Material.DECORATED_POT)};
    public final static String[] willCounter = {"§eSmooth Sandstone", "§fCalcite"};
    public final static Move move = new Move(new Structure(structure), "§6Decorated Pot", new String[]{"Counters §eSmooth Sandstone.", "Counters §fCalcite.", "Place ON TOP of it, and ", "it will flip back 4♥ damage."}, Util.emptyStringArr, willCounter) {
