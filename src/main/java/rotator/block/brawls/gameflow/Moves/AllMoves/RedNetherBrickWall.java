...
public class RedNetherBrickWall {
    public final static BlockInfo[] structure = {new BlockInfo(0, 0, 0, Material.RED_NETHER_BRICK_WALL)};
    public final static String[] willCounter = {"EndStoneBricks", "NetherBricks"};
    public final static Move move = new Move(new Structure(structure), "§4Red Nether Brick Wall", new String[]{"Counters End Stone Bricks.", "Counters Nether Bricks.", "Place ON TOP of it; then ", "it will flip back 4♥ damage."}, Util.emptyStringArr, willCounter) {
